...
def uvnet_2d_bn_incept_weigted(dim_data, dim_label, num_class, phase='train'):
	net = caffe.NetSpec()
	############ d0 ############
	net.data = L.Input(input_param=dict(shape=dict(dim=dim_data)))
	if phase == "train":
	...
	net.d1b_conv, net.d1b_bn, net.d1b_scale, net.d1b_relu = conv_bn_relu(net.d1a_concat, 128, pad=1, kernel_size=3, stride=1)
	...
	############ d2 ############
	# net.d2a_pool = max_pool(net.d1d_relu, pad=0, kernel_size=2, stride=2)
	net.d2a_pool, net.d2a_conv, net.d2a_bn, net.d2a_scale, net.d2a_relu, net.d2a_concat = pool_conv_bn_relu_concat(net.d1e_eltw, 128)
	net.d2b_conv, net.d2b_bn, net.d2b_scale, net.d2b_relu = conv_bn_relu(net.d2a_concat, 256, pad=1, kernel_size=3, stride=1)
	net.d2c_conv, net.d2c_bn, net.d2c_scale, net.d2c_relu = conv_bn_relu(net.d2b_relu, 256, pad=1, kernel_size=3, stride=1)
	...
	############ d3 ############
	# net.d3a_pool = max_pool(net.d2d_relu, pad=0, kernel_size=2, stride=2)
	net.d3a_pool, net.d3a_conv, net.d3a_bn, net.d3a_scale, net.d3a_relu, net.d3a_concat = pool_conv_bn_relu_concat(net.d2e_eltw, 256)
	net.d3b_conv, net.d3b_bn, net.d3b_scale, net.d3b_relu = conv_bn_relu(net.d3a_concat, 512, pad=1, kernel_size=3, stride=1)
	net.d3c_conv, net.d3c_bn, net.d3c_scale, net.d3c_relu = conv_bn_relu(net.d3b_relu, 512, pad=1, kernel_size=3, stride=1)
	...
	############ d4 ############
	# net.d4a_pool = max_pool(net.d3d_relu, pad=0, kernel_size=2, stride=2)
	net.d4a_pool, net.d4a_conv, net.d4a_bn, net.d4a_scale, net.d4a_relu, net.d4a_concat = pool_conv_bn_relu_concat(net.d3e_eltw, 512)
	net.d4b_conv, net.d4b_bn, net.d4b_scale, net.d4b_relu = conv_bn_relu(net.d4a_concat, 1024, pad=1, kernel_size=3, stride=1)
	net.d4c_conv, net.d4c_bn, net.d4c_scale, net.d4c_relu = conv_bn_relu(net.d4b_relu, 1024, pad=1, kernel_size=3, stride=1)
	...
	############ u3 ############
	### a ### First Deconvolution
	net.u3a_dconv, net.u3a_bn, net.u3a_scale, net.u3a_relu = deconv_bn_relu(net.d4e_eltw, 512, pad=0, kernel_size=2, stride=2)
	net.u3b_concat = L.Concat(net.u3a_relu, net.d3e_eltw, axis=1)
	net.u3c_conv, net.u3c_bn, net.u3c_scale, net.u3c_relu = conv_bn_relu(net.u3b_concat, 512, pad=1, kernel_size=3, stride=1)
	net.u3d_conv, net.u3d_bn, net.u3d_scale, net.u3d_relu = conv_bn_relu(net.u3c_relu, 512, pad=1, kernel_size=3, stride=1)
	net.u3e_conv, net.u3e_bn, net.u3e_scale = conv_bn(net.u3d_relu, 512, pad=1, kernel_size=3, stride=1)
	net.u3f_conv, net.u3f_bn, net.u3f_scale, net.u3f_eltw, net.u3f_relu = add_layer(net.u3b_concat, net.u3e_conv, 512)
	############ u2 ############
	### a ### Second Deconvolution
	net.u2a_dconv, net.u2a_bn, net.u2a_scale, net.u2a_relu = deconv_bn_relu(net.u3f_relu, 256, pad=0, kernel_size=2, stride=2)
	net.u2b_concat = L.Concat(net.u2a_relu, net.d2e_eltw, axis=1)
	net.u2c_conv, net.u2c_bn, net.u2c_scale, net.u2c_relu = conv_bn_relu(net.u2b_concat, 256, pad=1, kernel_size=3, stride=1)
	...
	### a ### Third Deconvolution
	net.u1a_dconv, net.u1a_bn, net.u1a_scale, net.u1a_relu = deconv_bn_relu(net.u2f_relu, 128, pad=0, kernel_size=2, stride=2)
	net.u1b_concat = L.Concat(net.u1a_relu, net.d1e_eltw, axis=1)
	net.u1c_conv, net.u1c_bn, net.u1c_scale, net.u1c_relu = conv_bn_relu(net.u1b_concat, 128, pad=1, kernel_size=3, stride=1)
	# net.u1d_conv, net.u1d_bn, net.u1d_scale, net.u1d_relu = conv_bn_relu(net.u1c_conv, 128, pad=1, kernel_size=3, stride=1)
	...
	### a ### Fourth Deconvolution
	net.u0a_dconv, net.u0a_bn, net.u0a_scale, net.u0a_relu = deconv_bn_relu(net.u1f_relu, 64, pad=0, kernel_size=2, stride=2)
	net.u0b_concat = L.Concat(net.u0a_relu, net.d0c_conv, axis=1)
	net.u0c_conv, net.u0c_bn, net.u0c_scale, net.u0c_relu = conv_bn_relu(net.u0b_concat, 64, pad=1, kernel_size=3, stride=1)
...
def uvnet_2d_bn_incept2_weigted(dim_data, dim_label, num_class, phase='train'):
	net = caffe.NetSpec()
	############ d0 ############
	net.data = L.Input(input_param=dict(shape=dict(dim=dim_data)))
	if phase == "train":
	...
	net.d1a_pool, net.d1a_conv, net.d1a_bn, net.d1a_scale, net.d1a_relu, net.d1a_concat = pool_conv_bn_relu_concat(net.d0c_relu, 64)
	net.d1b_conv, net.d1b_bn, net.d1b_scale, net.d1b_relu = conv_bn_relu(net.d1a_concat, 128, pad=1, kernel_size=3, stride=1)
	net.d1c_conv, net.d1c_bn, net.d1c_scale = conv_bn(net.d1b_relu, 128, pad=1, kernel_size=3, stride=1)
	# net.d1c_conv, net.d1c_bn, net.d1c_scale, net.d1c_relu = conv_bn_relu(net.d1b_relu, 128, pad=1, kernel_size=3, stride=1)
	# net.d1d_conv, net.d1d_bn, net.d1d_scale, net.d1d_relu = conv_bn_relu(net.d1c_relu, 256, pad=1, kernel_size=3, stride=1)
	# net.d1e_eltw = L.Eltwise(net.d1a_concat, net.d1c_relu, eltwise_param=dict(operation=1))
	net.d1e_conv, net.d1e_bn, net.d1e_scale, net.d1e_eltw, net.d1e_relu = add_layer(net.d1a_concat, net.d1c_conv, 128)
	...
	# net.d2e_eltw = L.Eltwise(net.d2a_concat, net.d2d_relu, eltwise_param=dict(operation=1))
	net.d2d_conv, net.d2d_bn, net.d2d_scale = conv_bn(net.d2c_conv, 256, pad=1, kernel_size=3, stride=1)
	net.d2e_conv, net.d2e_bn, net.d2e_scale, net.d2e_eltw, net.d2e_relu = add_layer(net.d2a_concat, net.d2d_conv, 256)
	...
	# net.d3e_eltw = L.Eltwise(net.d3a_concat, net.d3d_relu, eltwise_param=dict(operation=1))
	net.d3d_conv, net.d3d_bn, net.d3d_scale = conv_bn(net.d3c_conv, 512, pad=1, kernel_size=3, stride=1)
	net.d3e_conv, net.d3e_bn, net.d3e_scale, net.d3e_eltw, net.d3e_relu = add_layer(net.d3a_concat, net.d3d_conv, 512)
	...
	# net.d4e_eltw = L.Eltwise(net.d4a_concat, net.d4d_relu, eltwise_param=dict(operation=1))
	net.d4d_conv, net.d4d_bn, net.d4d_scale = conv_bn(net.d4c_conv, 1024, pad=1, kernel_size=3, stride=1)
	net.d4e_conv, net.d4e_bn, net.d4e_scale, net.d4e_eltw, net.d4e_relu = add_layer(net.d4a_concat, net.d4d_conv, 1024)
...
def make_uvnet(net, dim_data, dim_label, num_class, prototxt_train, prototxt_test):
	# register net
	__nets = ['uvnet_2d_bn', 'uvnet_2d_bn_weigted', 'uvnet_2d_bn_original_weigted', 'uvnet_2d_bn_modified_weigted', 'uvnet_2d_bn_incept_weigted', 'uvnet_2d_bn_incept2_weigted']
	...
	if net == 'uvnet_2d_bn_incept_weigted':
		use_global_stats = 0
		train_net = uvnet_2d_bn_incept_weigted(dim_data, dim_label, num_class, phase='train')
		use_global_stats = 1
		test_net = uvnet_2d_bn_incept_weigted(dim_data, dim_label, num_class, phase='test')

	if net == 'uvnet_2d_bn_incept2_weigted':
		use_global_stats = 0
		train_net = uvnet_2d_bn_incept2_weigted(dim_data, dim_label, num_class, phase='train')
		use_global_stats = 1
		test_net = uvnet_2d_bn_incept2_weigted(dim_data, dim_label, num_class, phase='test')
